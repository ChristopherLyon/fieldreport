                ...
                <div className="flex items-center justify-center py-12 w-full">
                    <div className="mx-auto w-[350px] gap-10 flex flex-col items-center text-center">
                        ...
                        <div className="flex flex-col gap-4 w-full">
                            <Button onClick={() => signIn("google", { callbackUrl: "/" })} variant="outline" className="w-full" autoFocus>
                                <span>
                                    Login with Google
                                </span>
                                <Image
                            ...
                            <Button onClick={() => signIn("github", { callbackUrl: "/" })} variant="outline" className="w-full">
                                <span>
                                    Login with Github
                                </span>
                                <Image
