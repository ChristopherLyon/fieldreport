...
export async function POST(request: Request) {
  ...
  const aiPrompt = `
...

    {
        ...
        "task": {
            "is_task": true, // Whether the stream should be flagged as a task
            ...
            "priority": "low" | "medium" | "high" | "urgent", // The priority level of the task
            "title": "string", // The title of the task
            "description": "string", // The description of the task
            "sub_tasks": [  // An array of sub-tasks (at least one subtask required)
                {
                    "title": "string", // The title of the sub-task
                    "description": "string", // The description of the sub-task
                    "due_date": "Date", // The due date of the sub-task - format: 2024-06-02T08:59:40.544Z
