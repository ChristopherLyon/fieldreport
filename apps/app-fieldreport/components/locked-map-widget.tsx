        ...
        <main className="h-full border rounded-lg overflow-hidden bg-muted">
            ...
            {location ?
                <Map
                    ...
                    initialViewState={{ longitude: location.longitude, latitude: location.latitude, zoom: 10 }}
                    mapStyle={theme.theme == "light" ? "mapbox://styles/mapbox/light-v10" : "mapbox://styles/mapbox/dark-v10"}
                ...
                : <div className="flex items-center justify-center h-full">
                    <div className="flex flex-row items-center gap-2">
                        ...
                        <div className="text-xs font-medium animate-pulse">Fetching location...</div>
                    </div>
