...
import VideoAndTitleBlock from '@/components/video-and-title-block';
import UserStory from '@/components/user-stories';
...
export default function Home() {
  return (
    <main className="h-screen font-raleway">
      ...
      <ProductFeatures />
      <VideoAndTitleBlock
        videoUrl="/videos/solar-farm.mov"
        title="Built for the people who build our future."
      />
      ...
      <VideoAndTitleBlock
        videoUrl="/videos/office.mp4"
        title="Effortlessly manage millions of moving parts."
      />
          ...
          userStories={[
            {
              ...
              description:
                'Access the full suite of features from your computer, both via the web app and the desktop app.',
              userStory:
            ...
            },
            {
              ...
              description:
                'Stay connected and informed on the go with the FieldReport mobile app, available on iOS and Android.',
              userStory:
